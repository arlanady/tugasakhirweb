...
$pdf->Image('../logo/web.jpg',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'WEB MBOIS ILAKES',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. SEOKARNOO-HATTA NO. 1986',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.webmboisilakes.com email : webmboisilakes@gmail.com',0,'L');
